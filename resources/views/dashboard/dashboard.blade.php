...
<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Latest Admissions</h3>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="studentprofile">Eragon Shadeslayer</a></td>
                    <td>New Student</td>
                   </tr> 
                  <tr>
                    <td><a href="studentprofile">Saphira</a></td>
                    <td>Transferee</td>
                  </tr> 
                  </tbody>
                </table>
            ...
            <div class="box-footer clearfix">
              <a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">View All Admitted Students</a>
            </div>
            <!-- /.box-footer -->
          </div>
</div>
<div class="col-md-6">
          <div class="box box-info">
            ...
            <!-- /.box-body -->
            <div class="box-footer clearfix">
              <a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">View All Enrolled Students</a>
            </div>
            <!-- /.box-footer -->
          </div>
</div>
