  ...
  <div class="modal fade" id="addModalOne" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form autocomplete="off" data-toggle="validation" role="form" method="post" action="{{ route('section.store') }}" name="formAdd" id="formAdd">
        {{ csrf_field() }}
  ...
  <div class="modal fade" id="updateModalOne" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form autocomplete="off" data-toggle="validation" role="form" action="{{ route('section.update','id') }}" method="post" name="updSection" id="updSection">
        {{ method_field('PUT') }}
        {{ csrf_field() }}
        <div class="modal-body">
